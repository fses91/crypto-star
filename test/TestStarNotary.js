...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal('Nice NFTs', await instance.name.call());
    assert.equal('NNT', await instance.symbol.call());
});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(starName, await instance.lookUptokenIdToStarInfo(starId))
});